...
def build_model(ann_height, **model_args):
    ...
    totalCoreVolume = math.pi*ann_height*((fuel_outer_diam/2)**2-(central_hole_diam/2)**2)
    print(f"Total Core Volume: {totalCoreVolume}")
    totalUO2Mass = weights[0]*totalCoreVolume
    print(f"Total UO2 Mass: {totalUO2Mass}")
    U238atPerc = (0.9/238)/((0.1/235)+(0.9/238))
    U235atPerc = (0.1/235)/((0.1/235)+(0.9/238))
    avgUmm = U235atPerc*235+U238atPerc*238
    print(avgUmm)
